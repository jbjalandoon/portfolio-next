...
export default function Project({
  ...
  return (
    <div className='flex h-96 w-full flex-col rounded-2xl bg-slate-800 px-8 py-5 gap-7 shadow-xl'>
      ...
      <button className='w-44 self-center border border-emerald-300 py-2 font-bold transition-colors duration-500 hover:bg-emerald-300 hover:text-slate-900'>
        See More
      </button>
